...
module.exports.save = () => {
  return new Promise((resolve, _reject) => {
      ...
      .then(() => {
        return new Promise((resolve, reject) => {
          fs.writeFile(
              config.get('dataFile'), JSON.stringify(this.tasks), err => {
                if (err)
                  return reject(err);
                else
                  return resolve();
...
module.exports.filterTasks = filter => {
  return new Promise((resolve, reject) => {
           ...
           if (filter.parents !== undefined)
             filters.push(
                 o => _.difference(filter.parents, o.parents).length === 0);
           if (filter.children !== undefined)
             filters.push(
                 o => _.difference(filter.children, o.children).length === 0);
           if (filter.tags !== undefined)
             filters.push(o => _.difference(filter.tags, o.tags).length === 0);
           if (filter.open !== undefined)
             filters.push(o => o.open === filter.open);
           ...
           if (filter.dueBefore !== undefined)
             filters.push(
                 o => o.dueDate !== null && o.dueDate < filter.dueBefore);
           if (filter.dueAfter !== undefined)
             filters.push(
                 o => o.dueDate !== null && o.dueDate > filter.dueAfter);
           if (filter.entry !== undefined)
             filters.push(
                 o => o.entryDate !== null &&
                     moment(o.entryDate).diff(moment(filter.entry), 'days') ===
                         0);
           ...
           if (filter.done !== undefined)
             filters.push(
                 o => o.doneDate !== null &&
                     moment(o.doneDate).diff(moment(filter.done), 'days') ===
                         0);
           if (filter.doneBefore !== undefined)
             filters.push(
                 o => o.doneDate !== null && o.doneDate < filter.doneBefore);
           if (filter.doneAfter !== undefined)
             filters.push(
                 o => o.doneDate !== null && o.doneDate > filter.doneAfter);
           if (filter.modified !== undefined)
             filters.push(
                 o => o.modifiedDate !== null &&
                     moment(o.modifiedDate)
                             .diff(moment(filter.modified), 'days') === 0);
           if (filter.modifiedBefore !== undefined)
             filters.push(
                 o => o.modifiedDate !== null &&
                     o.modifiedDate < filter.modifiedBefore);
           if (filter.modifiedAfter !== undefined)
             filters.push(
                 o => o.modifiedDate !== null &&
                     o.modifiedDate > filter.modifiedAfter);
           resolve(
               _.filter(this.tasks, o => _.every(_.map(filters, f => f(o)))));
         })
      .then(tasks => {
        return new Promise(resolve => {
          var fuse = new Fuse(
              tasks,
              {shouldSort: true, threshold: 0.5, keys: ['uuid', 'title']});
...
module.exports.getUUID = filter => {
  return this.filterTasks(filter).then(tasks => {
    return new Promise((resolve, reject) => {
      ...
      var fuse = new Fuse(
          tasks, {shouldSort: true, threshold: 0.8, keys: ['uuid', 'title']});
      return resolve(
          inquirer
              .prompt([{
                type: 'autocomplete',
